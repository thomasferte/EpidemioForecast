...
plot_pi <- df_pi |> 
  ...
  mutate(pi_method = if_else(name %in% c("outcome", "pred"),
         ...
         pi_method = factor(pi_method,
                            levels = c("outcome", "pred", "Ad hoc", "Conformal", "Residuals", "BS"),
                            labels = c("Observed", "Predicted", "Ad hoc", "Conformal", "Residuals", "BS"))) |> 
...
plot_coverage <- df_pi_coverage |> 
  mutate(pi_method = factor(pi_method,
                            levels = c("Ad hoc", "Conformal", "Residuals", "BS"),
                            labels = c("Ad hoc", "Conformal", "Residuals", "BS"))) |> 
