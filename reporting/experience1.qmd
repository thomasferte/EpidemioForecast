...
plot_pi_rc_all <- df_pi |> 
  ...
  geom_line() +
  geom_line(mapping = aes(y = pred, color = "Predicted"), linewidth = 1, linetype = "21") +
  geom_line(mapping = aes(y = outcome, color = "Observed"), linewidth = 1, linetype = "21") +
...
```{r}
test <- read.csv(file = here::here("output/experience2/aggregated_results/emissions_logs.csv"))
a <- fct_compute_emissions(path = vec_path_experience[2])
```
